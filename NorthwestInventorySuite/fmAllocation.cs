...
{
    public partial class fmAllocation : Form
    {
        ...
        public fmAllocation(string status)
        {
            InitializeComponent();
            state = status;
        }

        private void fmAllocation_Load(object sender, EventArgs e)
        {
            try
            {
                ReportDocument cryRpt = new ReportDocument();
                string dir = System.IO.Directory.GetCurrentDirectory();
                dir = "StockAllocationReport.rpt";
                cryRpt.Load(dir);
